...
** It means that you can see what happens on HTML5 preview but 
...
You can read all changes between release in the link:changelog.adoc[changelog file].
...
include::module/README.adoc[Asciidoctor module documentation]
